...
public class Exercise3 {
	public static void main(String[] args) {
		...
		int increment = 3; //When the first three numbers are introduced this value stays at 3, but when a loop happens, it adds 3 to the value. Ex: 0 loops = 3, 1 loop = 6, 2 loops = 9, 3 loops = 12, etc...
